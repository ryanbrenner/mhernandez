...
// let's create the function for the News
function custom_post_example() { 
	...
	register_post_type( 'news', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'new_item' => __( 'New News', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View News', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search News', 'bonestheme' ), /* Search News Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the example news', 'bonestheme' ), /* News Description */
			'public' => true,
